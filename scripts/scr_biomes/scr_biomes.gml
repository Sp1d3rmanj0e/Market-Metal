...
Broken_City		  = create_biome_data(14, "Broken City",		c_fuchsia,			 spr_city				,[[RESOURCE.RUBBLE, 5], [RESOURCE.CRANE, 0.1], [RESOURCE.SKYSCRAPER1, 3.6], [RESOURCE.SKYSCRAPER2, 3.6]] , , 1, 1, create_weather_profile(50, 20, 2, 0));
...
Salt_Flats		  = create_biome_data(19, "Salt Flats",			rgb(154,211,68),     spr_salt_flats			,[[RESOURCE.IRON_ORE, 5]] , , 1, 1, create_weather_profile(100, 1, 1, 0));
