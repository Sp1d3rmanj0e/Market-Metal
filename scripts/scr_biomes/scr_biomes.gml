...
Plains			  = create_biome_data(8,  "Plains",				rgb(236, 238, 143),	 spr_plains				,[[RESOURCE.OAK_TREE, 2]] , , 2, create_weather_profile(70, 30, 8, 0));
...
Broken_City		  = create_biome_data(14, "Broken City",		c_fuchsia,			 spr_city				,[] , , 1, 1, create_weather_profile(50, 20, 2, 0));
